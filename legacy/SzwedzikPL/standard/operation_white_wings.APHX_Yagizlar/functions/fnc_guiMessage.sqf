...
"_ctrlRscMessageBoxPos","_ctrlRscMessageBoxPosH","_ehKeyDown","_status"];
...
uinamespace setvariable ["mission_guiMessage_status",nil];
_ctrlButtonOK ctrlseteventhandler ["buttonclick","uinamespace setvariable ['mission_guiMessage_status',true]; true"];
_ctrlButtonCancel ctrlseteventhandler ["buttonclick","uinamespace setvariable ['mission_guiMessage_status',false]; true"];
_display displayaddeventhandler ["unload","uinamespace setvariable ['mission_guiMessage_status',false];"];
_ehKeyDown = _display displayaddeventhandler ["keydown","if ((_this select 1) == 1) then {uinamespace setvariable ['mission_guiMessage_status',false]; true} else {false}"];


//--- Clicked
waituntil {!isnil {uinamespace getvariable "mission_guiMessage_status"}};
...
private _result = uiNamespace getVariable "mission_guiMessage_status";
uinamespace setVariable ["mission_guiMessage_status", nil];
missionNamespace setVariable ["mission_guiMessage_result", _result];
