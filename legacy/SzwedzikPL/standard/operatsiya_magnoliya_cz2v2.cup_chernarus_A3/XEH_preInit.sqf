...
[QGVAR(dayCount), {
  ...
  [
    [
      ...
      ["", "<br/>"],
      [format [LLSTRING(UI_DayCount_Day), _dayCount + 3], "font = 'PuristaMedium'"],
      ["", "<br/>"],
      [format ["Potwierdzone eliminacje: %1 (%2)", _kills, _kills + 1140], "font = 'PuristaMedium'"]
    ],
  	safeZoneX - 0.01,
