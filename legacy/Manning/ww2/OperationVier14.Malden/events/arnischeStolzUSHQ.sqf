...
titleText ["Nadajacy: Nadaje komunikat od Branderburger: Zlokalizowalismy lokalny sztab dowodzenia Amerykanow, przerwa.","PLAIN DOWN"];
sleep 10;
...
titleText ["Arnische Stolz: Sztab Amerykanski przejac, nie bombardowac.","PLAIN DOWN"];
sleep 10;
...
if(!hasInterface) then {sleep 140; boolZad_usHQ_map = true; publicVariable "boolZad_usHQ_map";}