...
while {true} do 
{
	...
	while {_usNumberPlanes + _gerNumberPlanes != 0} do 
	{
		...
		while{_usNumberPlanes != 0} do 
		{
			...
			_arrayPilots pushBack _usPilot;
			_arrayPlanes pushBack _usPlane;
		...
		while{_gerNumberPlanes != 0} do 
		{
			...
			_arrayPilots pushBack _gerPilot;
			_arrayPlanes pushBack _gerPlane;
		};
		
		sleep 120;
		
		{deleteVehicle _x} forEach _arrayPilots;
