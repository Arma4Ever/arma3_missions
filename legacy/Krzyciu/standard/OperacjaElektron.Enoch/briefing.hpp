...
<br/>
Przedostać się do kompleksu rakietowego.<br/>
...
Niebyłby to problem, gdyby nie to że prawdopodobnie postawi to w stan gotowości całe siły wroga w rejonie.<br/>
<br/>
"]];
...
W odpowiedzi na te działania podjęto decyzje o przeprowadzeniu uderzenia wyprzedzającego i zniszczeniu Liwońskich instalacji rakietowych.<br/>
