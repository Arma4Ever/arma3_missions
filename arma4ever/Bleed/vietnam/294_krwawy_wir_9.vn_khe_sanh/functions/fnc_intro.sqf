...
0 fadeEnvironment 0;
// intro film 
["arma4ever_mission_assets\krwawy_wir\intro.ogv"] call BIS_fnc_playVideo;
...
// Autor misji
titleText ["<t size='2' font='RobotoCondensedLight'>Misja by</t><br/><t size='3' font='RobotoCondensedBold'>" +"Bleed"+ "</t>", "PLAIN", -1, false, true];
sleep 3;
...
// Nazwa misji
titleText ["<t size='4' font='RobotoCondensedBold'>" + "Sprawiedliwość na wojnie jest jak skrawek papieru na wietrze." + "</t>", "PLAIN", -1, false, true];
titleFadeOut 9999999;
sleep 4.4;
