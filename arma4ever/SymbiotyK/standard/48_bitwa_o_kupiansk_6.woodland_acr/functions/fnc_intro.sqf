...
//Tekst
sleep 2;
titleText ["<t size='2' font='RobotoCondensedLight'>8 Września 2022</t><br/></t>", "PLAIN", -1, false, true];
sleep 2;
titleFadeOut 1;
sleep 2;

//2
titleText ["<t size='2' font='RobotoCondensedLight'>Ukraina</t><br/></t>", "PLAIN", -1, false, true];
sleep 2;
titleFadeOut 1;
sleep 3;
...
//3
titleText ["<t size='2' font='RobotoCondensedLight'>Rosyjskie ofensywy w pierwszych miesiącach inwazji na Ukrainę pozostawiły pod kontrolą rosyjską duże połacie obwodu charkowskiego, w tym kluczowe węzły logistyczne Izium i Kupiańsk.</t><br/></t>", "PLAIN", -1, false, true];
sleep 6;
titleFadeOut 1;
sleep 3;

//4
titleText ["<t size='2' font='RobotoCondensedLight'>Większość obwodu charkowskiego pozostała jednak pod kontrolą ukraińską, w tym miasto Charków, gdzie wojsko rosyjskie nieprzerwanie bombardowało rakietami, artylerią i amunicją kasetową aż do sierpnia.</t><br/></t>", "PLAIN", -1, false, true];
sleep 6;
titleFadeOut 1;
sleep 3;

//5
titleText ["<t size='2' font='RobotoCondensedLight'>Do 6 czerwca rosyjskie bombardowanie Charkowa zabiło 606 cywilów i zraniło 1248.</t><br/></t>", "PLAIN", -1, false, true];
sleep 4;
titleFadeOut 1;
sleep 3;

//6
titleText ["<t size='2' font='RobotoCondensedLight'>Siły ukraińskie powstrzymały rosyjskie postępy w kierunku Charkowa, następnie rozpoczęły kontrofensywę w maju. We wrześniu byli już pod Kupiańskiem.</t><br/></t>", "PLAIN", -1, false, true];
sleep 5;
titleFadeOut 1;
sleep 3;

//7
titleText ["<t size='2' font='RobotoCondensedLight'>Oto historia bohaterów, którzy walczą o wyzwolenie Ukrainy....</t><br/></t>", "PLAIN", -1, false, true];
sleep 4;
titleFadeOut 1;
sleep 3;
