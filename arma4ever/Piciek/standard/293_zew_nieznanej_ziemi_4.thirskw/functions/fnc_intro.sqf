...
// Logo A4E
["arma4ever_mission_assets\zew_nieznanej_ziemi\intrologozew.ogv"] call BIS_fnc_playVideo;
["arma4ever_mission_assets\zew_nieznanej_ziemi\intromisja.ogv"] call BIS_fnc_playVideo;
