...
titleText ["<t size='1.4' color='#f2f5f3'>Wczytywanie...</t>", "PLAIN DOWN", -1, false, true];
waitUntil {
  sleep 0.1;
...
waitUntil {
  ...
  if (_count > 0) then {
    ...
    titleText [format [
      "<t color='#f2f5f3'><t size='1.4'>%5</t><br/><t size='1.6'>%1%2</t><br/>%3/%4</t>",
      _percent,
      "%",
      _counter,
      _count,
...
titleText ["<t size='1.4' color='#f2f5f3'>Synchronizacja...</t>", "PLAIN DOWN", -1, false, true];
sleep 5;
