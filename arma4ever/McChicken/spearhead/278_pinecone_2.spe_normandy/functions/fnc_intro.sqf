...
// Muzyka - Cziken
playSound QGVAR(ChickenIntro);
// Logo Cziken
titleRsc [QGVAR(ChickenLogo), "PLAIN", 1];
titleFadeOut 9999999;
sleep 3;
...
// Logo misji
titleRsc [QGVAR(MisjaLogo), "PLAIN", 1];
titleFadeOut 9999999;
sleep 3;
...
sleep 5;
waitUntil { sleep 1; !(missionNamespace getVariable ["BIS_fnc_eventTimeline_playing",true]); };
