...
titleText ["<t size='2'>Lipiec 1973</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 3;
titleFadeOut 2;
sleep 2;

titleText ["<t size='2'>Wywiad wojskowy stawia w gotowosc sily specjalne przy granicy Czechoslowacji</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Miejscowa policja i partyzanci raportuja o kradziezy pociagu z metalami ciezkimi</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Sily Ukladu Warszawskiego ingeruja poprzez zabezpieczenie kradziezy</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Z kopalni Susice ginie rowniez kilka pojemnikow</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Ludowe Wojsko Polskie w odpowiedzi na depesze NRD odmawia odpowiedzi</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>W obliczu zagrozenia i niejasnym informacjom o ladunku sztab decyduje sie na powazne kroki</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Z bazy lotniczej w teren operacji startuje oddzial specjalny US Army</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;

titleText ["<t size='2'>Nadchodzi ciezka, cicha noc...</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;
