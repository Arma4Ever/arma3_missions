...
titleText ["<t size='2'>26 listopada 1991</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 3;
titleFadeOut 2;
sleep 2;

titleText ["<t size='2'>Swiat odetchnal z ulga - zelazna kurtyna runela</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Zwiazek Radziecki przestal istniec... na pozor.</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Ruski mir obral za cel destabilizacje i podporzadkowanie sobie Moldawii</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Ofiara FSB padl dystrykt Naddniestrza</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Poprzez licznych kolaborantow bezpieka Rosji stworzyla Bojowa Partie Pracy</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Szybko przerodzila sie ona w formacje paramilitarna</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;


titleText ["<t size='2'>Rzad Moldawii podjal ostateczna decyzje o dekonspiracji terenow Naddniestrza</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;

titleText ["<t size='2'>W teren operacji wyslano czesc komapanii Celmare</t><br/></t>", "PLAIN", -1, FALSE, TRUE];
sleep 5;
titleFadeOut 2;
sleep 2;
